...
public class Explorer extends JFrame {
	...
	private class Explorar extends JPanel {
		...
		public Explorar(Usuario u, List<Actividad> l) {
			this.setLayout(null);
	 ...
	 * Create the frame.
	 */
	public Explorer(Usuario u) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 450, 300);
		if (u instanceof Estudiante) {
			try {
				contentPane = new Explorar(u, Curso.getTodosLosCursos(), Actividad.getTodasLasActividades());
			...
			try {
				contentPane = new Explorar(u, Actividad.getTodasLasActividades());
			} catch (ParseException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		} else if (u instanceof Profesor) {
			contentPane = new Explorar(u,Curso.getTodosLosCursos());
		} else {
