...
public class Explorar2 extends JPanel {
	...
	public Explorar2(Estudiante u, List<Curso> c, List<Actividad> a) {
	...
	public Explorar2(List<Curso> c, List<Actividad> a) {
		usuario = null;
		setLayout(null);
		addElements(c, a);
	...
	public Explorar2(Profesor u, List<Curso> l) {
		usuario = u;
		this.setLayout(null);
	...
	public Explorar2(Organizacion u, List<Actividad> l) {
		usuario = u;
		this.setLayout(null);
